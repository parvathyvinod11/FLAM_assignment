"""
fit_curve.py (Differential Evolution approach)
"""
...
# 4. Parameter bounds
bounds = [
    (np.radians(0.01), np.radians(49.99)), # theta
    (-0.0499, 0.0499),                     # M
    (0.01,    99.99),                      # X
]

# 5. Optimization
print("Running scipy.optimize.differential_evolution...")
print("(This performs a global search to avoid local minima)\n")
...
print("  Final Estimated Parameters (Differential Evolution)")
print()
